...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 6b1af76c-ec6d-46cd-a5e1-23c52928ae6f
```

> `6b1af76c-ec6d-46cd-a5e1-23c52928ae6f` is the password of the certificate, you can change it to any password you want.
